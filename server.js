...
async function seedDatabase() {
  ...
  await Presentation.insertMany([
    ...
    { title:'Structural Engineering — Load Analysis', author:'Dr. Akash Pundir', institution:'Lovely Professional University', cat:'engineering', desc:'Dead loads, live loads, seismic analysis, and structural design principles. Includes case studies of iconic structures.', tags:['Structural','Load Analysis','Seismic','Civil'], slideCount:45, downloads:143, views:412, likes:38 },
  ]);
